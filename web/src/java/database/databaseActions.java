...
import dataManipulations.encryptor;
import dataManipulations.splitter;
    ...
    public String logIn (String login, String password)
    {
        try {
            ...
            while (rs.next())
            {
                ...
                {
//                    User tempUser = new User(rs.getString(2), rs.getString(3));
//                  String toEncrypt = rs.getString(2) + "," + rs.getString(3);
...
//                projects += "," + rs.getInt(1);
    ...
    public int getIdByLogin (String login)
     ...
     public String getProjectNames(String login)
    {
...
//            ArrayList<Integer> projectIds = getUserProjectIds(user);
...
//                projectNames.add(rs.getString(1));
                projectNames += "," + rs.getString(1);
            }
            
            return projectNames.substring(1);
        }
        catch (Exception e)
        {
            e.printStackTrace();
